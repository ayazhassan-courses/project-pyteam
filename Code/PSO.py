...
def PSO():
    ...
    Num_Iterations = 200     # number of iterations in search space
    Num_Particles = 50       # number of particles to be performed
    ...
    gbest_val = float('inf')  # setting global best value of swarm to infinity
